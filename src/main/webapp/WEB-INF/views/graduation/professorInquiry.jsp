...
<body>
  ...
  <div id="breadcrumb">
    ...
    <div class="aboutus">
   	...
   	<div class="modal fade" id="professorAdd" tabinex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="images/abouti/professor-1.png" style="width:180px; height:200px; float:left; border-radius:5px; padding-right:20px;">

                    <p>사번<input type="text" class="form-control" name="professorNum" style="width:250px"></p>
                    <p>이름<input type="text" class="form-control" style="width:250px" ></p>
                    <p>소속 학과
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="alert('해당교수에 대한 정보를 추가하시겠습니까?')">추가</button>
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade" id="professorDelete" tabinex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="padding-bottom:1.5px;">
                ...
                <div class="modal-body">
                    ...
                    <p>사번<input type="text" class="form-control" value="20100000" name="professorNum" style="width:250px"></p>
                    <p>이름<input type="text" class="form-control" value="홍은지" style="width:250px" ></p>
                    <p>소속 학과
                        <select name="department" class="form-control" style="width:250px">
                            <option>소프트웨어공학과</option>
                            <option>컴퓨터공학과</option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="alert('해당교수에 대한 정보를 삭제하시겠습니까?')">삭제</button>
                </div>
            </div>
        </div>
    </div>
