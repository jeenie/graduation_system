						...
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation" class="dropdown"><a
									...
									<div class="dropdown-content">
										<a href="${R}graduation/professorInquiry">교수조회</a> <a
	...
	<div class="aboutus">
		<div class="container"
			...
			<div style="margin-left: 250px;">
				<form:form method="post" modelAttribute="professor" autocomplete="off">
					<div class="form-group">
						<label>교번</label>
						<input type="text" name="id" value="" class="form-control" style="width:350px"/>
					...
					<button type="submit" class="btn-statement4" style="width:60px; height:35px" onclick="alert('해당 교수의 정보를 추가하시겠습니까?')">저장</button>
				</form:form>
			</div>
