...
<body onload="initialize()">
		...
		<div class="carousel slide">
			<div class="carousel-inner">
				<div class="item active"
					style="background-image: url(res/img/graduation-3.jpg)">
					<div class="container">
	...
	<div class="modal fade" id="registerModal" tabinex="-1" role="dialog"
		aria-labelledby="modal" aria-hidden="true">
		<div class="modal-dialog">
				...
				<div class="modal-body">
					<form>
						<div class="from-group">
							<label class="label-modal">이름</label> <input type="text"
								name="studentName" class="form-control" maxlength="20">
						</div>

						<div class="from-group">
							<label class="label-modal">학번</label> <input type="text"
								name="studentNumber" class="form-control" maxlength="20">
						</div>

						<div class="from-group">
							<label class="label-modal">학과</label> <input type="text"
								name="studentMajor" class="form-control" maxlength="20">
						</div>

						<div class="from-group">
							<label class="label-modal">학년</label> <input type="text"
								name="studentYear" class="form-control" maxlength="1">
						</div>
						...
						<div class="form-group">
							<label>비밀번호 찾기 질문</label> <select class="form-control"
								name="findPassword">
						...
						<div class="from-group">
							<label class="label-modal">비밀번호 찾기 답변</label> <input type="text"
								name="passwordAnswer" class="form-control" maxlength="20">
						</div>

						<div class="from-group">
							<label class="label-modal">OTP</label> <input type="text"
								name="studentOTP" class="form-control"
								style="width: 350px; margin: 0;" maxlength="20"> <input
								type="button" class="btn btn-line"
								style="margin-left: 0px; font-size: 14px; height: 34px;"
								value="OTP 확인">
						</div>

						<div class="from-group">
							<label class="label-modal">이수 과목 목록 첨부</label> <input type="file"
								name="studentDB" class="form-control" maxlength="20">
						</div>
